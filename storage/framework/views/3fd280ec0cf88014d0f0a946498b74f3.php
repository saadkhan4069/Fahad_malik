...
<div class="dashboard-container">
            ...
            <div class="col-md-6">
                <div class="company-info">
                    <div class="user-badge">
                        <span class="user-id"><?php echo e($user->id); ?> - <?php echo e($user->name); ?></span>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="activity-card card-blue">
                    <div class="card-body-vertical">
                        <div class="top-section">
                            <div class="big-number"><?php echo e($stats['unpaid_invoices']); ?></div>
                            <div class="label">Pending Invoices</div>
                        </div>
                        <div class="bottom-section">
                            <div class="big-number"><?php echo e($stats['overdue_invoices']); ?></div>
            ...
            <div class="col-md-2">
                <div class="activity-card card-purple">
                    <div class="card-body-vertical">
                        <div class="top-section">
                            <div class="big-number"><?php echo e($user->company->name); ?></div>
                            <div class="label">My Company</div>
                        </div>
                        <div class="bottom-section">
                            <div class="big-number"><?php echo e(ucfirst($user->role)); ?></div>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="table-section">
                <div class="table-header">
                    <h5>My Bookings <?php echo e(now()->subDays(3)->format('d/m/Y')); ?>-<?php echo e(now()->format('d/m/Y')); ?></h5>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <a href="<?php echo e(route('user.bookings.show', $booking)); ?>" class="text-success"><?php echo e($booking->cn_number); ?></a>
                                </td>
                                ...
                                <td>
                                    <?php if($booking->shipment): ?>
                                        <span class="text-success"><?php echo e($booking->shipment->tracking_number); ?></span>
                                    <?php else: ?>
                                        <span class="text-muted">N/A</span>
                                    <?php endif; ?>
                                </td>
                                <td><?php echo e($booking->weight); ?> kg</td>
                                <td><?php echo e($booking->goods_value_currency ?? 'PKR'); ?> <?php echo e(number_format($booking->total_cost, 2)); ?></td>
                                <td>
                                ...
                                <td>
                                    <a href="<?php echo e(route('user.bookings.show', $booking)); ?>" class="btn btn-sm btn-outline-success">
        ...
        <div class="col-md-6">
            <div class="table-section">
                <div class="table-header">
                    <h5>My Invoices <?php echo e(now()->subDays(3)->format('d/m/Y')); ?>-<?php echo e(now()->format('d/m/Y')); ?></h5>
                    <i class="fas fa-minus"></i>
                </div>
                <div class="table-controls">
                    <div class="row">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($invoice->booking->cn_number); ?></td>
                                ...
                                <td>
                                    <a href="<?php echo e(route('user.invoices.show', $invoice)); ?>" class="btn btn-sm btn-outline-success">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                </td>
                            </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Fahad_malik_logisitic\shipment_booking_fahad_malik\resources\views/user/dashboard-new.blade.php ENDPATH**/ ?>