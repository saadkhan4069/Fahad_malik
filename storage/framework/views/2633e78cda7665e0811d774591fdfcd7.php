    ...
    <div class="hdr">
      ...
      <img style="margin-top: -32px;" class="logo" src="../../../storage/company/logos/EUF6Xc4fXfp5oIew8OM7SWMnwICEvoPT16rqUkfR.jpg" alt="AdEx Logo">
        ...
        <?php elseif(file_exists(public_path('images/logo.png'))): ?>
          ...
          <img class="logo" src="<?php echo e(asset('images/logo.jpg')); ?>" alt="AdEx Logo">
        <?php else: ?>
    ...
    <div class="twocol mb12">
      ...
      <div class="box">
        <table class="grid">
          ...
          <tr><td class="lbl">Shipment Charges</td><td class="val"><?php echo e('PKR'); ?> <?php echo e(number_format($booking->shipment_charges ?? 0, 2)); ?></td></tr>
          <?php
          ...
          ?>
          <?php if($len && $wid && $hei): ?>
            <tr><td class="lbl">Dimensions (L×W×H)</td><td class="val"><?php echo e($len); ?> × <?php echo e($wid); ?> × <?php echo e($hei); ?></td></tr>
          <?php endif; ?>
          <?php if($vol): ?>
            <tr><td class="lbl">Volumetric Weight</td><td class="val"><?php echo e($vol); ?></td></tr>
          <?php endif; ?>
        </table>
      </div>
    </div>
...
<?php /**PATH /home/u796145342/domains/adexcourier.com/public_html/portal/resources/views/invoices/proforma.blade.php ENDPATH**/ ?>