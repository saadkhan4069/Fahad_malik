        ...
        <div class="col-12">
            <div class="booking-form-container">
                ...
                <p class="form-description">Please fill out the form below to book your shipment. Fields marked with * are required.</p>
                    ...
                    <form id="booking-form" method="POST" action="<?php echo e(route('user.bookings.store')); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="shipment_reference" name="shipment_reference" value="<?php echo e(Auth::user()->company->company_name ?? 'Admin'); ?>-<?php echo e(Auth::user()->name ?? 'Admin'); ?>" required readonly>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u796145342/domains/adexcourier.com/public_html/portal/resources/views/user/bookings/create.blade.php ENDPATH**/ ?>