        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                        <a href="<?php echo e(route('bookings.edit', $booking)); ?>" class="btn btn-outline-primary">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Fahad_malik_logisitic\shipment_booking_fahad_malik\resources\views/bookings/show.blade.php ENDPATH**/ ?>