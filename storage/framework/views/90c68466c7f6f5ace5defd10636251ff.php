...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
        <a href="<?php echo e(route('user.labels.index')); ?>" class="btn btn-outline-secondary">
            <i class="fas fa-arrow-left me-1"></i> Back to Labels
        </a>
        <a href="<?php echo e(route('user.labels.download', $label)); ?>" class="btn btn-success" target="_blank">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <p><?php echo e($label->label_number); ?></p>
                    </div>
                    <div class="col-md-6 mb-3">
                        <strong>Label Type:</strong>
                        <p><span class="badge bg-info"><?php echo e(ucfirst($label->label_type)); ?></span></p>
                    </div>
                    <div class="col-md-6 mb-3">
                        <strong>Status:</strong>
                        <p>
                            <span class="badge bg-<?php echo e($label->status == 'generated' ? 'success' : 'warning'); ?>">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <p><?php echo e($label->generated_at->format('M d, Y H:i')); ?></p>
                    </div>
                    <?php if($label->printed_at): ?>
                    <div class="col-md-6 mb-3">
                        <strong>Printed At:</strong>
                        <p><?php echo e($label->printed_at->format('M d, Y H:i')); ?></p>
                    </div>
                    <?php endif; ?>
                    <?php if($label->file_size): ?>
                    <div class="col-md-6 mb-3">
                        <strong>File Size:</strong>
                        <p><?php echo e(number_format($label->file_size / 1024, 2)); ?> KB</p>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <p class="h6 text-primary"><?php echo e($label->individual_tracking_number ?? $label->shipment->tracking_number); ?></p>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <p>
                            <span class="badge bg-info">
                                <?php echo e(ucfirst(str_replace('_', ' ', $label->individual_status ?? $label->shipment->status))); ?>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <p><?php echo e($label->shipment->origin_address); ?></p>
                    </div>
                    <div class="col-md-6 mb-3">
                        <strong>Destination:</strong>
                        <p><?php echo e($label->shipment->destination_address); ?></p>
                    </div>
                    <div class="col-md-6 mb-3">
                        <strong>Weight:</strong>
                        <p><?php echo e($label->shipment->weight); ?> kg</p>
                    </div>
                    <div class="col-md-6 mb-3">
                        <strong>Shipping Cost:</strong>
                        <p class="h6 text-primary">PKR <?php echo e(number_format($label->shipment->shipping_cost, 2)); ?></p>
                    </div>
                </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <p><?php echo e($label->shipment->booking->booking_number); ?></p>
                    </div>
                    <div class="col-md-6 mb-3">
                        <strong>Service Type:</strong>
                        <p><span class="badge bg-info"><?php echo e(ucfirst($label->shipment->booking->service_type)); ?></span></p>
                    </div>
                    <div class="col-md-6 mb-3">
                        <strong>Shipper:</strong>
                        <p><?php echo e($label->shipment->booking->shipper_name); ?></p>
                    </div>
                    <div class="col-md-6 mb-3">
                        <strong>Consignee:</strong>
                        <p><?php echo e($label->shipment->booking->consignee_name); ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-lg-4">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body text-center">
                <?php if($label->file_path && file_exists(public_path('storage/' . $label->file_path))): ?>
                    <div class="mb-3">
                        <img src="<?php echo e(asset('storage/' . $label->file_path)); ?>" 
                             alt="Label Preview" 
                ...
                <a href="<?php echo e(route('user.labels.download', $label)); ?>" class="btn btn-primary w-100" target="_blank">
...
<div class="modal fade" id="labelTrackingModal" tabindex="-1" aria-labelledby="labelTrackingModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" action="<?php echo e(route('user.labels.update-tracking', $label)); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="label_tracking_notes" name="tracking_notes" rows="3" placeholder="Add tracking notes specific to this label..."><?php echo e($label->individual_tracking_notes); ?></textarea>
                    </div>
                    <div class="mb-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Fahad_malik_logisitic\shipment_booking_fahad_malik\resources\views/user/labels/show.blade.php ENDPATH**/ ?>