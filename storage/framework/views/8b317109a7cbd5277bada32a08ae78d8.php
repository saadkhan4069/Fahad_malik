            ...
            <div class="col-12">
                <div class="tracking-container">
                    ...
                    <div class="tracking-form">
                        ...
                        <form method="POST" action="<?php echo e(route('tracking.track')); ?>">
                            <?php echo csrf_field(); ?>
                            
                            <div class="tracking-input mb-4">
                                <i class="fas fa-search"></i>
                                <input type="text" 
                                       class="form-control <?php $__errorArgs = ['tracking_number'];
...
<?php /**PATH /home/u796145342/domains/adexcourier.com/public_html/portal/resources/views/tracking/index.blade.php ENDPATH**/ ?>