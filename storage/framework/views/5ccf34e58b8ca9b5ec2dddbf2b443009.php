<?php $__env->startSection('title', 'Company Register'); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                   name="company_name" value="<?php echo e(old('company_name')); ?>" required autocomplete="company_name" autofocus>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input id="contact_person" type="text" class="form-control <?php $__errorArgs = ['contact_person'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                   name="contact_person" value="<?php echo e(old('contact_person')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                  name="address" rows="2" required><?php echo e(old('address')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="text-center mt-4">
                    <p class="text-muted">Already have an account? 
                        <a href="<?php echo e(route('company.login')); ?>" class="text-decoration-none">Login here</a>
                    </p>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u796145342/domains/adexcourier.com/public_html/portal/resources/views/auth/company-register.blade.php ENDPATH**/ ?>