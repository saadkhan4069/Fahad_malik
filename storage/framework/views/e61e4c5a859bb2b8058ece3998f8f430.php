    ...
    <div class="grid2">
      <div class="col block">
        ...
        <div class="dl">
          ...
          <div class="row"><div class="dt">City, Country:</div><div class><?php echo e($label->shipment->origin_city ?? '-'); ?>, <?php echo e($label->shipment->origin_country ?? '-'); ?></div></div>
        </div>
      </div>
      ...
      <div class="col block">
        ...
        <div class="dl">
          ...
          <div class="row"><div class="dt">City, Country:</div><div class="dd"><?php echo e($label->shipment->destination_city ?? '-'); ?>, <?php echo e($label->shipment->destination_country ?? '-'); ?></div></div>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="grid2">
      <div class="col">
        <div class="dl">
          ...
          <div class="row"><div class="dt">Total Weight:</div><div class="dd"><?php echo e($label->shipment->weight ?? '0.00'); ?> kg</div></div>
      ...
      <div class="col">
        <div class="dl">
          ...
          <div class="row"><div class="dt">Shipment Charges:</div><div class="dd"><?php echo e($label->shipment->booking->goods_value_currency ?? 'USD'); ?> <?php echo e(number_format($label->shipment->booking->shipment_charges ?? 0, 2)); ?></div></div>
        </div>
      </div>
    </div>
  </div>
...
<?php /**PATH D:\Fahad_malik_logisitic\shipment_booking_fahad_malik\resources\views/labels/enhanced-pdf.blade.php ENDPATH**/ ?>