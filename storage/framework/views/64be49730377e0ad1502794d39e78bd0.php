                    ...
                    <!-- Error Messages -->
                        ...
                        <div class="form-section">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="consignee_attention" class="form-label">Attention</label>
                                        <input type="text" class="form-control" id="consignee_attention" name="consignee_attention" value="<?php echo e(old('consignee_attention', $booking->consignee_attention)); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="service" name="service" required>
                                            ...
                                            <?php $__currentLoopData = \App\Models\Service::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($service->name); ?>" <?php echo e(old('service', $booking->service) == $service->name ? 'selected' : ''); ?>>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Fahad_malik_logisitic\shipment_booking_fahad_malik\resources\views/bookings/edit.blade.php ENDPATH**/ ?>