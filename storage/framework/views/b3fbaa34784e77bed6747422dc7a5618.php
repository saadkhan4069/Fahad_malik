...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
        <a href="<?php echo e(route('user.bookings.index')); ?>" class="btn btn-outline-secondary me-2">
            <i class="fas fa-arrow-left me-1"></i> Back to Bookings
        </a>
        
        <!-- Edit Button -->
        <a href="<?php echo e(route('user.bookings.edit', $booking)); ?>" class="btn btn-primary me-2">
            <i class="fas fa-edit me-1"></i> Edit Booking
        </a>
        
        <!-- Proforma Invoice Button -->
        <a href="<?php echo e(route('user.invoices.proforma', $booking)); ?>" class="btn btn-info me-2" target="_blank">
            <i class="fas fa-file-invoice me-1"></i> Proforma Invoice
        </a>
        <a href="<?php echo e(route('user.invoices.proforma.pdf', $booking)); ?>" class="btn btn-outline-info">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                        ...
                        <a href="<?php echo e(route('user.bookings.edit', $booking)); ?>" class="btn btn-primary">
                            <i class="fas fa-edit me-1"></i> Edit Booking
                        </a>
                        
                        <?php if($booking->status == 'pending'): ?>
                        <form method="POST" action="<?php echo e(route('user.bookings.confirm', $booking)); ?>" style="display: inline;">
                        <?php echo csrf_field(); ?>
                ...
                <?php if($booking->shipment): ?>
                        <div class="border-top pt-3 mt-3">
                            ...
                            <form method="POST" action="<?php echo e(route('user.labels.generate', $booking->shipment)); ?>" style="display: inline;">
                                <?php echo csrf_field(); ?>
                            ...
                            <?php if($booking->shipment->labels && $booking->shipment->labels->count() > 0): ?>
                                <a href="<?php echo e(route('user.labels.show', $booking->shipment->labels->first())); ?>" class="btn btn-outline-info w-100 mb-2">
                                    <i class="fas fa-eye me-1"></i> View Existing Label
                                </a>
                                <a href="<?php echo e(route('user.labels.download', $booking->shipment->labels->first())); ?>" class="btn btn-outline-success w-100" target="_blank">
                ...
                <?php endif; ?>
                    ...
                    <!-- <div class="border-top pt-3 mt-3">
                        ...
                        <a href="<?php echo e(route('user.invoices.proforma', $booking)); ?>" class="btn btn-info w-100 mb-2" target="_blank">
                            <i class="fas fa-file-invoice me-1"></i> View Proforma
                        </a>
                        <a href="<?php echo e(route('user.invoices.proforma.pdf', $booking)); ?>" class="btn btn-outline-info w-100">
                            <i class="fas fa-download me-1"></i> Download PDF
                        </a>
                    </div> -->
                </div>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <form method="POST" action="<?php echo e(route('user.bookings.mark-paid', $booking)); ?>" style="display: inline;">
                            <?php echo csrf_field(); ?>
...
<div class="modal fade" id="trackingModal" tabindex="-1" aria-labelledby="trackingModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" action="<?php echo e(route('user.shipments.update-tracking', $booking->shipment)); ?>">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u796145342/domains/adexcourier.com/public_html/portal/resources/views/user/bookings/show.blade.php ENDPATH**/ ?>