                ...
                <div class="welcome-container">
                    ...
                    <div class="text-center p-5">
                        ...
                        <div class="row justify-content-center mb-4" >
                            <div class="col-md-6">
                                <a href="{{ route('tracking.index') }}" class="btn btn-unified w-100">
                        ...
                        <div class="row justify-content-center mb-4">
                            <div class="col-md-6">
                                <a href="{{ route('login') }}" class="btn btn-unified w-100">
                        ...
                        <div class="row justify-content-center" >
                            <div class="col-md-6 mb-3" style="display: none;">
                                <a href="{{ route('register') }}" class="btn btn-outline-unified w-100">
                                    <i class="fas fa-building me-2"></i>Register Company
                                </a>
                            </div>
                            <div class="col-md-6 mb-3" >
                                <a href="{{ route('user.register') }}" class="btn btn-outline-unified w-100">
