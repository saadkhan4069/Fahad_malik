        ...
        <div class="col-12">
            <div class="booking-form-container">
                ...
                <p class="form-description">Please fill out the form below to book your shipment. Fields marked with * are required.</p>
                    ...
                    <form id="booking-form" method="POST" action="{{ route('user.bookings.store') }}">
                        @csrf
                        ...
                        <h3 class="section-title">Shipment Information</h3>
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="date" class="form-control" id="estimated_date" name="estimated_date" value="{{ date('Y-m-d') }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="shipment_reference" name="shipment_reference" value="{{ Auth::user()->company->company_name ?? 'Admin' }}-{{ Auth::user()->name ?? 'Admin' }}" required readonly>
