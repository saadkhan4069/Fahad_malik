...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
        ...
        <a href="{{ route('invoices.proforma', $booking) }}" class="btn btn-info me-2" target="_blank">
            <i class="fas fa-file-invoice me-1"></i> Proforma Invoice
        </a>
        <!--<a href="{{ route('invoices.proforma.pdf', $booking) }}" class="btn btn-outline-info">-->
            ...
            <div class="card-body">
                ...
                @if($booking->shipment)
                        <div class="border-top pt-3 mt-3">
                            ...
                            <form method="POST" action="{{ route('labels.generate', $booking->shipment) }}" style="display: inline;">
                                @csrf
                            ...
                            @if($booking->shipment->labels && $booking->shipment->labels->count() > 0)
                                <a href="{{ route('labels.show', $booking->shipment->labels->first()) }}" class="btn btn-outline-info w-100 mb-2">
                                    <i class="fas fa-eye me-1"></i> View Existing Label
                                </a>
                                <a href="{{ route('labels.download', $booking->shipment->labels->first()) }}" class="btn btn-outline-success w-100" target="_blank">
                ...
                @endif
                    ...
                    <!-- <div class="border-top pt-3 mt-3">
                        ...
                        <a href="{{ route('invoices.proforma', $booking) }}" class="btn btn-info w-100 mb-2" target="_blank">
                            <i class="fas fa-file-invoice me-1"></i> View Proforma
                        </a>
                        <a href="{{ route('invoices.proforma.pdf', $booking) }}" class="btn btn-outline-info w-100">
                            <i class="fas fa-download me-1"></i> Download PDF
                        </a>
                    </div> -->
                </div>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <form method="POST" action="{{ route('bookings.mark-paid', $booking) }}" style="display: inline;">
                            @csrf
...
<div class="modal fade" id="trackingModal" tabindex="-1" aria-labelledby="trackingModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('shipments.update-tracking', $booking->shipment) }}">
                @csrf
                @method('PUT')
