                ...
                <div class="tracking-container">
                    ...
                    <div class="shipment-info">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="info-item">
                                    ...
                                    <span class="info-value">{{ $shipment->weight ?? 1 }} kg</span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-item">
                                    <span class="info-label">Destination:</span>
                                    <span class="info-value">{{ strtoupper($shipment->destination_address ?? 'Destination') }}</span>
                                </div>
                                <!-- <div class="info-item">
                                    <span class="info-label">Current Status:</span>
                                    <span class="info-value">
                                        <span class="status-badge {{ $shipment->status === 'delivered' ? 'status-completed' : 'status-pending' }}">
                        ...
                        <div class="info-item">
                            ...
                            <span class="info-value">{{ $shipment->tracking_notes }}</span>
                        </div>
                        @endif
                    </div>
                    ...
                    <div class="timeline">
                        ...
                        <div class="timeline-item">
                            <div class="timeline-icon {{ $event['status'] === 'completed' ? 'completed checkmark' : 'pending' }}">
                    ...
                    <div class="text-center p-4">
                        <a href="{{ route('tracking.index') }}" class="btn-back">
